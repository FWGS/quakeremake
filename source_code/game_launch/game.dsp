...
# ADD LINK32 msvcrt.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo /subsystem:windows /pdb:none /machine:I386 /nodefaultlib:"libc.lib" /out:"quake.exe" /opt:nowin98
# Begin Custom Build
InputPath=.\quake.exe
SOURCE="$(InputPath)"

"D:\Quake\quake.exe" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy quake.exe "D:\Quake\quake.exe"
