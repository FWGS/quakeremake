...
# Begin Custom Build
TargetDir=\Quake\id1\quake_remake_devkit\source_code\temp\mainui\!release
InputPath=\Quake\id1\quake_remake_devkit\source_code\temp\mainui\!release\menu.dll
SOURCE="$(InputPath)"

"D:\Quake\id1\cl_dlls\menu.dll" : $(SOURCE) "$(INTDIR)" "$(OUTDIR)"
	copy $(TargetDir)\menu.dll "D:\Quake\id1\cl_dlls\menu.dll"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "./" /I "../common" /I "../pm_shared" /I "../engine" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /FAs /FR /FD /GZ /c
# SUBTRACT CPP /YX
...
# Begin Custom Build
TargetDir=\Quake\id1\quake_remake_devkit\source_code\temp\mainui\!debug
InputPath=\Quake\id1\quake_remake_devkit\source_code\temp\mainui\!debug\menu.dll
SOURCE="$(InputPath)"
